      ...
      <AuthCard>
        <div className="space-y-6 animate-in fade-in duration-500">
          ...
          >
            ...
            <Button
              type="submit"
              className="h-12 w-full rounded-xl bg-blue-600 cursor-pointer font-semibold text-white shadow-lg shadow-blue-500/30 hover:bg-blue-700 hover:shadow-xl hover:shadow-blue-500/40 transition-all transform hover:scale-[1.02] active:scale-[0.98] mt-6"
            >
              Crear cuenta
            </Button>
          </form>
          ...
          <Button
            type="button"
            variant="outline"
            className="h-12 w-full rounded-xl border-2 border-gray-300 bg-white font-semibold cursor-pointer text-gray-700 hover:bg-gray-50 hover:border-gray-400 transition-all transform hover:scale-[1.02] active:scale-[0.98]"
          >
